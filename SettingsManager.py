...
class SettingsManager:
    ...
    def __init__(self):
        ...
        tk.Label(tk_root, text="Images extensions to consider", width=labels_shape[0], height=labels_shape[1]).grid(row=2, column=0)
        ...
        tk.Label(tk_root, text="Videos extensions to consider", width=labels_shape[0], height=labels_shape[1]).grid(row=3, column=0)
